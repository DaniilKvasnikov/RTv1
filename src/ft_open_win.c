...
/*   Updated: 2019/02/27 16:06:00 by rrhaenys         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	char **argv)
{
	...
	objects_add_sphere(data, new_sphere(vector_new(0, 0, 3), 1, 0x0000ff));
	objects_add_sphere(data, new_sphere(vector_new(0, -1, 8), 5, 0xff0000));
}
