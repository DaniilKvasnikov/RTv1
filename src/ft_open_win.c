...
/*   Updated: 2019/02/23 08:05:59 by rrhaenys         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	char **argv)
{
	...
	data->mydata->norm = (double *)malloc(sizeof(double) * (WIN_W * WIN_H));
	data->mydata->mat = (t_matrix *)malloc(sizeof(t_matrix));
	objects_add_sphere(data, new_sphere(vector_new(0, 0, 3), 1, 0xff));
	objects_add_sphere(data, new_sphere(vector_new(0, 0, 8), 5, 0xff0000));
}
